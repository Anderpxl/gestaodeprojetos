...
public class EquipeService {
    // Método para cadastrar novas equipes no sistema/banco de dados relacionando com colaboradores e projetos
    public void cadastrarEquipe() {
        ...
        System.out.print("Quantos colaboradores deseja adicionar? ");
    ...
    // Método para listar as equipes cadastradas no sistema/banco de dados relacionando os ID de colaboradores e gerentes
    public void listarEquipes() {
        ...
        for(Equipe e : lista) {
            ...
            if (e.getGerente() != null) {
                ...
                System.out.println("Gerente: nenhum gerente atribuido à equipe");
            }
    ...
    // Método para alterar equipes cadastradas no sistema baseado nas opções estabelecidas no switch/case
